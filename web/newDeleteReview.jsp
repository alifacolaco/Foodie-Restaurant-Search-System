<%-- 
    Document   : newDeleteReview
    Created on : 13 Apr, 2016, 9:19:42 PM
    Author     : ANISH   BHARNE
--%>
...
<html lang="en">
<head>
    <title>Delete Review Home Page</title>
	<meta charset="utf-8">
            <style>
                html, body {
                    width:100%;	
		...
		<div class="bgr">
			...
			<section id="content">
				...
				<div class="block-2 pad-1" style="margin-top:100px">
                                    <h3 class="h3-line top-1">Delete Restaurant Reviews:</h3>
					<div class="box-3">
                                            <%
                                    	...
                                    	<%
                                                ...
                                                {
                                        %>
                            		There are no records in review table for deleting
                                        <%
                                		} // end of else
                                            }
                                            catch (Exception e)
                                        ...
                                        {
                                            String review_id=request.getParameter("SelectedRecord");
                                            if(review_id != null) {
                                                int deleteResult=0;
                                    		Connection conn = null;
                                		Statement stmt = null;
                                                try
                                		{
                                                    ...
                                                    stmt = conn.createStatement();
                                                    String sqlSt="delete from reviews where review_id  = "+review_id +"";
